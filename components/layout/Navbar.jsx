      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-10 lg:space-x-12">
            ...
            <Link
              href="/contact"
              className="bg-black text-white px-8 py-3 lg:px-4 lg:py-1 text-sm lg:text-base border border-transparent hover:bg-transparent hover:border-black hover:text-black transition duration-300 no-underline"
            >
              Contact Us
            </Link>
          </div>
